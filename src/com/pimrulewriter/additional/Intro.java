...
public class Intro {
    ...
    public void intro (){
        System.out.println( Colors.ANSI_BLUE +
                ...
                "                                                                            \n" + Colors.ANSI_RESET);
        System.out.println(Colors.ANSI_CYAN + "Welcome to PIM Rule Writer by Piotr Dawidziuk" + Colors.ANSI_RESET);
        System.out.println(Colors.ANSI_YELLOW + "To use this program you must prepare a csv file with columns of data that is going to be used to create a YAML file with rules."+ Colors.ANSI_RESET);
    }
